...
export default function Formvalidation() {
    ...
    return (
        <div className="container mt-5 p-3 rounded" style={{width:'500px', background:'lavender'}}>
            <form onSubmit={handleSubmit(onSubmitForm)}>
                <div class="form-floating mb-3 mt-3">
                    <input type="text" class="form-control" id="name" placeholder="กรุณากรอกชื่อสินค้า" name="name"
